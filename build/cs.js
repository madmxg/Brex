...
/***/ function(module, exports, __webpack_require__) {
	...
	var _betCs = __webpack_require__(20);
	
	var _betCs2 = _interopRequireDefault(_betCs);
	
	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
	
	var log = new _betLogger2.default('Brex:cs:' + window.location.hostname);
	
	if (chrome.runtime.onMessage) {
	  log('cs script start');
	
	  var crex = new _betCs2.default({
	    pluginId: "plugin1"
	  });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _betApi = __webpack_require__(21);
	
	var _betApi2 = _interopRequireDefault(_betApi);
	
	var _betCtor = __webpack_require__(22);
	...
	var _betTalker = __webpack_require__(23);
	
	var _betTalker2 = _interopRequireDefault(_betTalker);
	
	var _betHelper = __webpack_require__(31);
	...
	var log = new _betLogger2.default('BET:cs:' + window.location.hostname);
	
	var BetContentScript = function () {
	  function BetContentScript(app) {
	    _classCallCheck(this, BetContentScript);
	    ...
	    this.api = new _betApi2.default(this.talker);
	  }
	
	  _createClass(BetContentScript, [{
	    key: 'load',
	    value: function load() {
	      log('load');
	    ...
	    key: 'proceed',
	    value: function proceed(modules) {
	      log('proceed frame ' + (window !== top), modules);
	
	      this.api.gs.set('rrr', 'ttt', function (data) {
	        return log('gs set ', data);
	      });
	      this.api.ajax.get({ url: 'http://localhost:8080/manifest.json' }, function (data) {
	        return log('get ajax', data);
	      });
	      ...
	      var s = modules['0']; // mount on start
	      var d = modules['1']; // mount on dom ready
	      var r = modules['2']; // mount with random delay
	      var x = modules['x']; // mount with delay x
	    ...
	    key: 'mountWithDelay',
	    value: function mountWithDelay(modules) {
	      var _this = this;
	
	      if (modules[0].length) {
	        log('mountWithDelay', modules[0]);
	
	        modules[0].forEach(function (module) {
	          log('mountWithDelay for each', module);
	
	          _betHelper2.default.contentLoaded(window, function () {
	            setTimeout(function () {
	              log('mountWithDelay delay', module[0]);
	
	              _this.addWithTag(module[1]);
	            }, module[0]);
	          });
	        });
	      }
	    ...
	    key: 'mountWithRandomDelay',
	    value: function mountWithRandomDelay(r) {
	      var _this2 = this;
	
	      _betHelper2.default.contentLoaded(window, function () {
	        setTimeout(function () {
	          _this2.mountModules(r);
	        }, _betHelper2.default.random(10000, 180000));
	      });
	    }
	  }, {
	    key: 'mountWhenReadyDom',
	    value: function mountWhenReadyDom(d) {
	      var _this3 = this;
	
	      _betHelper2.default.contentLoaded(window, function () {
	        _this3.mountModules(d);
	      });
	    }
	  }, {
	    key: 'mountModules',
	    value: function mountModules(modules) {
	      var _this4 = this;
	
	      if (modules[0].length) {
	        modules[0].forEach(function (module) {
	          _this4.addWithTag(module);
	        });
	      }
	      if (modules[1].length) {
	        modules[1].forEach(function (module) {
	          _this4.addWithoutTag(module);
	        });
	      }
	    }
	  }, {
	    key: 'addWithTag',
	    value: function addWithTag(m) {
	    ...
	    key: 'addWithoutTag',
	    value: function addWithoutTag(m) {
	      m = '(function(W, D, A, M){\n' + m + '\n})(w, d, a, m);';
	      _betCtor2.default.function('w, d, a, m', m)(window, document, this.api, this.modules);
	      log('mounted as new function');
	    }
	  }]);
	
	  return BetContentScript;
	}();
	
	exports.default = BetContentScript;
	;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var log = new _betLogger2.default('BET:api:' + window.location.hostname);
	
	var BetApi = function () {
	  function BetApi(talker) {
	    _classCallCheck(this, BetApi);
	  ...
	  _createClass(BetApi, [{
	    key: 'apiGS',
	    value: function apiGS(reason, key, value, cb) {
	      log('apiGS %s', reason);
	    ...
	    key: 'apiAjax',
	    value: function apiAjax(method, data, cb) {
	      log('apiAjax %s', method);
	
	      var reason = method + '.ajax';
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _betSeed = __webpack_require__(24);
	...
	var _betApiChrome = __webpack_require__(25);
	
	var _betApiChrome2 = _interopRequireDefault(_betApiChrome);
	
	var _betMessenger = __webpack_require__(32);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _betAjax = __webpack_require__(26);
